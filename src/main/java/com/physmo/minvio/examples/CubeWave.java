...
class CubeWave {
    ...
    static Color backCol = new Color(92, 108, 113);
    static Color topCol = new Color(252, 252, 253);
    static Color leftCol = new Color(96, 159, 184);
    static Color rightCol = new Color(159, 209, 245);
    ...
    public static void drawColumns(BasicDisplay bd, int xx, int yy) {
        ...
        for (int x = gridSize; x > 0; x--) {
            for (int y = 0; y < gridSize; y++) {
                ...
                h += (int) ((Math.sin(x/3.0+time)*5)+(Math.cos(x/2.5+time)*5));
